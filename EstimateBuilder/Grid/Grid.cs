...
namespace EstimateBuilder
{
	...
	public class Grid : System.Windows.Forms.Form
	{
		...
		{ 
			//if(EstimateBuilder.ApplicationBuilder.EditMode != DataFormEditMode.Open)
			//{
				GridArea clickArea = GridEX.HitTest(); 
				switch ( clickArea ) 
				{
					case GridArea.CellButton:				
						EstimateBuilder.ApplicationBuilder.EditMode = DataFormEditMode.Open;
						this.Edit();				
						break;
        ...
        {
            EstimateBuilder.frmFilter filterDialog = new frmFilter();
		...
		public  virtual void SaveSettings() 
		{
                ...
                
            {
                    ...
                    EstimateBuilder.SettingData viewRow = new EstimateBuilder.SettingData();
        ...
        protected void Export(DataTable dtExport)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    EstimateBuilder.Export objExport = new Export("Win");

                    //objExport.Export_with_XSLT_Windows(set1, textArray1, textArray2, FormatType, FileName);


                    objExport.ExportDetails(dtExport, EstimateBuilder.Export.ExportFormat.Excel, dlg.FileName);
