...
namespace EstimateBuilder 
{
	...
	{ 
		...
		private EstimateBuilder.Grid mView; 
		public Object ShowDialog( GridEX grid, Form parent, EstimateBuilder.Grid GridEXView ) 
		{ 
			mGridEX = grid; 
			mView = GridEXView; 
			SetFieldsLabel(); 
					   ...
					   { 
						   ...
						   if ( !( ( column == null ) ) && column.Visible ) 
									  { 
										  ...
										  strFields.Append( EstimateBuilder.Grid.GetColumnFriendlyName( column ) ); 
									  } 
					   } 
					   ...
					   { 
						   foreach ( Janus.Windows.GridEX.GridEXGroup transTemp0 in mGridEX.RootTable.Groups ) 
									  { 
										  ...
										  strFields.Append(EstimateBuilder.Grid.GetColumnFriendlyName( group.Column ) ); 
					   ...
					   { 
						   foreach ( Janus.Windows.GridEX.GridEXSortKey transTemp1 in mGridEX.RootTable.SortKeys ) 
									  { 
										  ...
										  strFields.Append( EstimateBuilder.Grid.GetColumnFriendlyName( sortKey.Column ) ); 
