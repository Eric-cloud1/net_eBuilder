...
namespace EstimateBuilder
{
	...
	/// </summary>
	public class Assembly :  EstimateBuilder.DataForm
	{
        private EstimateBuilderControl.Assembly assembly1;
		...
		private void InitializeComponent()
		{
            ...
            this.assembly1 = new EstimateBuilderControl.Assembly();
            this.SuspendLayout();
// 
// assembly1
// 
...
// 
		...
		public  EstimateBuilder.AssemblyMDI  assembly = new EstimateBuilder.AssemblyMDI();
		...
		public void CreateNewAssembly( EstimateBuilder.AssemblyMDI  _assembly)
		{
			EstimateBuilder.ApplicationBuilder.EditMode = DataFormEditMode.AddNew;
		...
		public void CreateAssembly( EstimateBuilder.AssemblyMDI  _assembly)
		{
		...
		public void Edit( EstimateBuilder.AssemblyData  _formAssembly,  EstimateBuilder.AssemblyMDI  _assembly ) 
		{
            this.assembly1.Assembly_Load();
		...
		protected EstimateBuilder.AssemblyData FormAssembly = new AssemblyData();
		protected EstimateBuilder.AssemblyDataProvider DataAssembly = new AssemblyDataProvider();
