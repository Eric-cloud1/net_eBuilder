...
namespace EstimateBuilder
{
	...
	/// </summary>
	public class ValidationUser : EstimateBuilder.DataForm
	{
        private EstimateBuilderControl.ValidationUser validationUser1;
		...
		private void InitializeComponent()
		{
            ...
            this.validationUser1 = new EstimateBuilderControl.ValidationUser();
            this.SuspendLayout();
// 
// validationUser1
// 
...
// 
		...
		public  EstimateBuilder.ValidationUserMDI validationUser = new EstimateBuilder.ValidationUserMDI();
		protected EstimateBuilder.ValidationUserData FormValidationUser = new ValidationUserData();
		...
		public void CreateNewValidationUser( EstimateBuilder.ValidationUserMDI  _validationUser)
		{
		...
		public void CreateValidationUser( EstimateBuilder.ValidationUserMDI  _validationUser)
		{
		...
		public void Edit( EstimateBuilder.ValidationUserData  _formValidationUser,  EstimateBuilder.ValidationUserMDI  _validationUser) 
		{
            this.validationUser1.ValidationUser_Load();
		...
		public override void InsertData() 
		{
			...
			EstimateBuilder.ApplicationBuilder.ValidationUserDataSource.add(FormValidationUser);	
		} 
		...
		public override void UpdateData() 
		{
			...
			EstimateBuilder.ApplicationBuilder.ValidationUserDataSource.update(FormValidationUser);		
		} 
		...
		{ 	
			...
			EstimateBuilder.ApplicationBuilder.ValidationUserDataSource.delete(FormValidationUser);	
		} 
