...
namespace EstimateBuilder
{
	...
	/// </summary>
	public class Quantity : EstimateBuilder.DataForm
	{
        private EstimateBuilderControl.Quantity quantity1;
		...
		private void InitializeComponent()
		{
            ...
            this.quantity1 = new EstimateBuilderControl.Quantity();
            this.SuspendLayout();
// 
// quantity1
// 
...
// 
		...
		public  EstimateBuilder.QuantityMDI  localquantity = new EstimateBuilder.QuantityMDI();

		protected EstimateBuilder.QuantityData FormQuantity = new QuantityData();
		...
		public void CreateNewQuantity( EstimateBuilder.QuantityMDI  _quantity)
		{
			EstimateBuilder.ApplicationBuilder.EditMode = DataFormEditMode.AddNew;
		...
		public void CreateQuantity( EstimateBuilder.QuantityMDI  _quantity)
		{
		...
		public void Edit( EstimateBuilder.QuantityData  _formQuantity,  EstimateBuilder.QuantityMDI  _quantity ) 
		{
            this.quantity1.Quantity_Load();
            this.localquantity = _quantity;
        ...
        //    this.quantity1.dlJobID.SelectedText = EstimateBuilder.ApplicationBuilder.quantityJobId;
        ...
        public override void InsertData() 
		{
            ...
            EstimateBuilder.ApplicationBuilder.EditMode = DataFormEditMode.AddNew;
             ...
             EstimateBuilder.ApplicationBuilder.QuantityDataSource.add(FormQuantity); 
		...
		public override void UpdateData() 
		{
            ...
            EstimateBuilder.ApplicationBuilder.QuantityDataSource.update(FormQuantity); 
		...
		public override void DeleteData()
        {
			...
			EstimateBuilder.ApplicationBuilder.QuantityDataSource.delete(FormQuantity);
