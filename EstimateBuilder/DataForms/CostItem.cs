...
namespace EstimateBuilder
{
	...
	/// </summary>
	public class CostItem : EstimateBuilder.DataForm
	{
        private EstimateBuilderControl.CostItem costItem1;
		...
		private void InitializeComponent()
		{
            ...
            this.costItem1 = new EstimateBuilderControl.CostItem();
            this.SuspendLayout();
// 
// cmdSaveClose1
// 
...
// 
		...
		public  EstimateBuilder.CostItemMDI  costItem = new EstimateBuilder.CostItemMDI();	
		protected EstimateBuilder.CostItemData FormCostItem = new CostItemData();
		...
		public void CreateNewCostItem( EstimateBuilder.CostItemMDI  _costItem)
		{
			EstimateBuilder.ApplicationBuilder.EditMode = DataFormEditMode.AddNew;
		...
		public void CreateCostItem( EstimateBuilder.CostItemMDI  _costItem)
		{
		...
		public void Edit( EstimateBuilder.CostItemData  _formItem,  EstimateBuilder.CostItemMDI  _costItem ) 
		{
            this.costItem1.CostItem_Load();
		...
		public override void InsertData() 
		{
            ...
            EstimateBuilder.ApplicationBuilder.EditMode = DataFormEditMode.AddNew;
			EstimateBuilder.ApplicationBuilder.CostItemDataSource.add(FormCostItem);		
		} 
		...
		public override void UpdateData() 
		{
            ...
            EstimateBuilder.ApplicationBuilder.EditMode = DataFormEditMode.Edit;
			EstimateBuilder.ApplicationBuilder.CostItemDataSource.update(FormCostItem);		
		} 
		...
		public override void DeleteData() 
		{
			...
			EstimateBuilder.ApplicationBuilder.CostItemDataSource.delete(FormCostItem);	
		} 
