...
namespace EstimateBuilder
{
	...
	public static void UpdateQuantity(int _value, string _expressionID)
	{
		...
		public static void SetStacks(string  _expressionID, string _jobID, Stack intStack1,Stack opStack1 )
		{
            ...
            try
			{
				DataTable dt = _data.getDataSet(strSQL.ToString(), EstimateBuilder.ApplicationBuilder.connection).Tables[0];	
     ...
     public class data1
	{
		...
		public  EstimateBuilder.data1[] select(string _id)
		{
			StringBuilder strSQL = new StringBuilder();
			EstimateBuilder.stData  _data = new EstimateBuilder.stData();
			...
			if (_count != 0)
			{
				EstimateBuilder.data1[] Array1 = new  EstimateBuilder.data1[_count - 1];
  
				for (int num1 = 0; num1 <_count; num1++)
				{
					EstimateBuilder.data1 package1 = new EstimateBuilder.data1();
					EstimateBuilder.data1 package2 = package1;
        ...
        public void add(EstimateBuilder.data1  _data1)
		{
			StringBuilder strSQL = new StringBuilder();
			EstimateBuilder.stData  _data = new EstimateBuilder.stData();
		...
		public EstimateBuilder.data1[] add(EstimateBuilder.data1[] _data1, EstimateBuilder.data1 _data2)
		{
