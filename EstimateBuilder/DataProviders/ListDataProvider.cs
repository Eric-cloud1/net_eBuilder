...
namespace EstimateBuilder
{
    ...
    public class ListDataProvider
    {
        ...
        {
           _connect = EstimateBuilder.ApplicationBuilder.connection;
        }
        ...
        public DivisionDatasExpression selectExpression(string _jobID)
        {
            ...
            EstimateBuilder.stData data = new EstimateBuilder.stData();
            ...
            EstimateBuilder.DivisionDatasExpression _ExpressionDatas = new EstimateBuilder.DivisionDatasExpression();
            ...
            foreach (DataRow _row in _dsData.Tables[0].Rows)
            {
                ...
                {
                    DivisionDataExpression _ExpressionData = new EstimateBuilder.DivisionDataExpression();
...
//			return dsTable;
        ...
        public void SaveGridView(string _grid, string _view, int _X, int _Y)
        {
            ...
            EstimateBuilder.stData _data2 = new EstimateBuilder.stData();
            strSQL2.Append(" INSERT INTO GridView ( Grid, Favorite, XWidth, YHeight) ");
            strSQL2.Append(" VALUES( '" + _grid + "', '" + _view + "',"+ _X +","+ _Y +") ");
            try
            {
                _data2.ExecuteSQL(strSQL2.ToString(), EstimateBuilder.ApplicationBuilder.connection);
            }
            catch { }
