...
namespace IDIGITALTEKGRID
{
	...
	/// </summary>
	public class EstimateMDI :  IDIGITALTEKGRID.Grid
	{
		/// <summary>
        ...
        public override void Refresh()
        {
            ...
            this.lbProjectName.Text = IDIGITALTEKGRID.ApplicationBuilder.estimateId;
            this.estimate = IDIGITALTEKGRID.ApplicationBuilder.EstimateDataSource.select(IDIGITALTEKGRID.ApplicationBuilder.estimateId,this.dlSelectEstimate.SelectedIndex);      
        ...
        private IDIGITALTEKGRID.EstimateDatas estimate;
		...
		public void createEstimatetMDI(string _id)
		{
            ...
            this.lbProjectName.Text = IDIGITALTEKGRID.ApplicationBuilder.estimateId;
			this.Select(IDIGITALTEKGRID.ApplicationBuilder.estimateId);
		}
        ...
        public void Select(string _id)
        {
            ...
            this.load(IDIGITALTEKGRID.ApplicationBuilder.estimateId);

            if(IDIGITALTEKGRID.ApplicationBuilder.OpenEstimateMode != OpenEstimate.On)
			{
				IDIGITALTEKGRID.ApplicationBuilder.OpenEstimateMode = OpenEstimate.On;
				this.Show();
			}
		...
		public override void load(string _id)
		{
            ...
            estimate = IDIGITALTEKGRID.ApplicationBuilder.EstimateDataSource.select(_id, this.dlSelectEstimate.SelectedIndex);
...
//				{ 
//					IDIGITALTEKGRID.EstimateDataProvider Estimate  = new IDIGITALTEKGRID.EstimateDataProvider(); 
//					
//					Estimate.update((IDIGITALTEKGRID.EstimateData) item.GetRow().DataRow);
//				} 
//			}
//			this.Refresh(IDIGITALTEKGRID.ApplicationBuilder.estimateId);
//			IDIGITALTEKGRID.ApplicationBuilder.EditMode = DataFormEditMode.Insert;
            ...
            switch (result)
            {
                case DialogResult.Yes:
                    ...
                    foreach (Janus.Windows.GridEX.GridEXSelectedItem transTemp1 in this.GridEX.SelectedItems)
                    {
                        ...
                        {
                            IDIGITALTEKGRID.EstimateDataProvider Estimate = new IDIGITALTEKGRID.EstimateDataProvider();
                            this.estimate.Remove((IDIGITALTEKGRID.EstimateData)item.GetRow().DataRow);
		...
		{ 
			...
			{ 
				...
				if ( item.RowType == RowType.Record ) 
				{ 
					//IDIGITALTEKGRID.r reportDialog = new IDIGITALTEKGRID.Report(); 
					//reportDialog.Edit(  (IDIGITALTEKGRID.reportData) item.GetRow().DataRow,   this); 
				} 
			}
		}
        ...
        public void addItem(ArrayList _importedData)
        {
			...
			IDIGITALTEKGRID.EstimateDatas _EstimateData = new IDIGITALTEKGRID.EstimateDatas();
		...
		{ 
            ...
            IDIGITALTEKGRID.ApplicationBuilder.XEstimate = this.ClientSize.Width;
            IDIGITALTEKGRID.ApplicationBuilder.YEstimate = this.ClientSize.Height;
        ...
        {
            DataTable dtExport = IDIGITALTEKGRID.ApplicationBuilder.EstimateDataSource.selectExport(IDIGITALTEKGRID.ApplicationBuilder.estimateId, this.dlSelectEstimate.SelectedIndex);
