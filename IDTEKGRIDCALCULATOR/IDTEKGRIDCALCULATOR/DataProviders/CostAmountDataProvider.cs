...
namespace IDIGITALTEKGRID
{
	...
	public class CostAmountDataProvider
	{
		...
		public void add(IDIGITALTEKGRID.CostAmountData  _costAmount)
		{
        ...
        public void Copy(IDIGITALTEKGRID.CostAmountData _costAmount)
        {
            StringBuilder strSQL = new StringBuilder();
            IDIGITALTEKGRID.stData _data = new IDIGITALTEKGRID.stData();
		...
		public void update(IDIGITALTEKGRID.CostAmountData _costAmount)
		{		
			StringBuilder strSQL = new StringBuilder();
			IDIGITALTEKGRID.stData  _data = new IDIGITALTEKGRID.stData();
		...
		public void delete(IDIGITALTEKGRID.CostAmountData _costAmount)
		{
			StringBuilder strSQL = new StringBuilder();
			IDIGITALTEKGRID.stData  _data = new IDIGITALTEKGRID.stData();
        ...
        public  IDIGITALTEKGRID.CostAmountDatas select(string _id)
		{

            DataSet dsData = this.selectData(_id);

            IDIGITALTEKGRID.CostAmountDatas _costAmountDatas = new IDIGITALTEKGRID.CostAmountDatas();

            int i = 0;
            foreach(DataRow row in dsData.Tables[0].Rows)
			{
				IDIGITALTEKGRID.CostAmountData _costAmountData = new IDIGITALTEKGRID.CostAmountData();
        ...
        public IDIGITALTEKGRID.CostAmountDatas select()
		{
