...
namespace IDIGITALTEKGRID
{
	...
	public class ExpressionDataProvider
	{
		...
		public void add(IDIGITALTEKGRID.ExpressionData  _ExpressionData)
		{
		...
		public void update(IDIGITALTEKGRID.ExpressionData  _ExpressionData)
		{		
			StringBuilder strSQL = new StringBuilder();
			IDIGITALTEKGRID.stData  _data = new IDIGITALTEKGRID.stData();
		...
		public void delete(IDIGITALTEKGRID.ExpressionData  _ExpressionData)
		{
			StringBuilder strSQL = new StringBuilder();
			IDIGITALTEKGRID.stData  _data = new IDIGITALTEKGRID.stData();
        ...
        public  IDIGITALTEKGRID.ExpressionDatas select(string _id)
		{
            DataSet dsData = this.selectData(_id);
            IDIGITALTEKGRID.ExpressionDatas _ExpressionDatas = new IDIGITALTEKGRID.ExpressionDatas();

            int i = 0;
            foreach(DataRow row in dsData.Tables[0].Rows)
			{
				IDIGITALTEKGRID.ExpressionData  _ExpressionData = new IDIGITALTEKGRID.ExpressionData();
        ...
        public IDIGITALTEKGRID.ExpressionDatas select()
		{
