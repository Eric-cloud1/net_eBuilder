...
namespace IDIGITALTEKGRID
{
	...
	public class JobDataProvider
	{
		...
		public void add(IDIGITALTEKGRID.JobData  _jobData)
		{
        ...
        public void Copy(IDIGITALTEKGRID.JobData _jobData)
        {
            StringBuilder strSQL = new StringBuilder();
            IDIGITALTEKGRID.stData _data = new IDIGITALTEKGRID.stData();
		...
		public void update(IDIGITALTEKGRID.JobData  _JobData)
		{		
			StringBuilder strSQL = new StringBuilder();
			IDIGITALTEKGRID.stData  _data = new IDIGITALTEKGRID.stData();
		...
		public void delete(IDIGITALTEKGRID.JobData  _jobData)
		{
			StringBuilder strSQL = new StringBuilder();
			IDIGITALTEKGRID.stData  _data = new IDIGITALTEKGRID.stData();
        ...
        public  IDIGITALTEKGRID.JobDatas select(string _id)
		{
            DataSet dsData = this.selectData(_id);
            IDIGITALTEKGRID.JobDatas _jobDatas = new IDIGITALTEKGRID.JobDatas();
            int i = 0;
            foreach(DataRow row in dsData.Tables[0].Rows)
			{
				IDIGITALTEKGRID.JobData  jobData = new IDIGITALTEKGRID.JobData();
        ...
        public IDIGITALTEKGRID.JobDatas select()
		{
