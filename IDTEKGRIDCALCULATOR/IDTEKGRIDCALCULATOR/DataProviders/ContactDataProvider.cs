...
namespace IDIGITALTEKGRID
{
	...
	public class ContactDataProvider
	{
		...
		public void add(IDIGITALTEKGRID.ContactData _contact)
		{
        ...
        public void Copy(IDIGITALTEKGRID.ContactData _contact)
        {
            StringBuilder strSQL = new StringBuilder();
            IDIGITALTEKGRID.stData _data = new IDIGITALTEKGRID.stData();
		...
		public void update(IDIGITALTEKGRID.ContactData _contact)
		{		
			StringBuilder strSQL = new StringBuilder();
			IDIGITALTEKGRID.stData  _data = new IDIGITALTEKGRID.stData();
		...
		#region tested
		public void delete(IDIGITALTEKGRID.ContactData _contact)
		{
			StringBuilder strSQL = new StringBuilder();
			IDIGITALTEKGRID.stData  _data = new IDIGITALTEKGRID.stData();
       ...
       public  DataSet selectData(string _id)
		...
		public  IDIGITALTEKGRID.ContactDatas select(string _id)
		{
            DataSet dsData = selectData(_id);

            IDIGITALTEKGRID.ContactDatas _contactDatas = new IDIGITALTEKGRID.ContactDatas();
                int i = 0;
                foreach (DataRow row in dsData.Tables[0].Rows)
                {
                    IDIGITALTEKGRID.ContactData _contactData = new IDIGITALTEKGRID.ContactData();
        ...
        public IDIGITALTEKGRID.ContactDatas select()
		{
