...
namespace IDIGITALTEKGRID
{
	...
	/// </summary>
	public class Job :  IDIGITALTEKGRID.DataForm
	{
        private IDIGITALTEKGRIDCONTROL.Job job1;
		...
		private void InitializeComponent()
		{
            ...
            this.job1 = new IDIGITALTEKGRIDControl.Job();
            this.SuspendLayout();
// 
// job1
// 
...
// 
		...
		public  IDIGITALTEKGRID.JobMDI  job = new IDIGITALTEKGRID.JobMDI();

        protected IDIGITALTEKGRID.JobData FormJob = new JobData();
		...
		public void CreateNewJob( IDIGITALTEKGRID.JobMDI  _job)
		{
		...
		public void CreateJob( IDIGITALTEKGRID.JobMDI  _job)
		{
        ...
        public void Edit( IDIGITALTEKGRID.JobData  _formJob,  IDIGITALTEKGRID.JobMDI  _job ) 
		{
            this.job1.Job_Load();
		...
		public override void InsertData() 
		{
            ...
            IDIGITALTEKGRID.ApplicationBuilder.JobDataSource.add(FormJob);
		...
		public override void UpdateData() 
		{
            ...
            IDIGITALTEKGRID.ApplicationBuilder.JobDataSource.update(FormJob);
		...
		public override void DeleteData() 
		{
            ...
            IDIGITALTEKGRID.ApplicationBuilder.JobDataSource.delete(FormJob);
