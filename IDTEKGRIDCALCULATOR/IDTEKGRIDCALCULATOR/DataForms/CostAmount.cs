...
namespace IDIGITALTEKGRID
{
	...
	/// </summary>
	public class CostAmount : IDIGITALTEKGRID.DataForm
	{
        private IDIGITALTEKGRIDCONTROL.CostAmount costAmount1;

	
		
	
		private IDIGITALTEKGRID.ApplicationBuilder application = new ApplicationBuilder();
		...
		private void InitializeComponent()
		{
            ...
            this.costAmount1 = new IDIGITALTEKGRIDControl.CostAmount();
            this.SuspendLayout();
// 
// costAmount1
// 
...
// 
		...
		public  IDIGITALTEKGRID.CostAmountMDI  costAmount = new IDIGITALTEKGRID.CostAmountMDI();
		
		protected IDIGITALTEKGRID.CostAmountData FormCostAmount = new CostAmountData();
		...
		public void CreateNewCostAmount(IDIGITALTEKGRID.CostAmountMDI  _costAmount)
		{
			IDIGITALTEKGRID.ApplicationBuilder.EditMode = DataFormEditMode.AddNew;
		...
		public void CreateCostAmount(IDIGITALTEKGRID.CostAmountMDI  _costAmount)
		{
		...
		public void Edit(IDIGITALTEKGRID.CostAmountData  _formCostAmount,  IDIGITALTEKGRID.CostAmountMDI  _costAmount ) 
		{
		...
		public override void InsertData() 
		{
			...
			IDIGITALTEKGRID.ApplicationBuilder.CostAmountDataSource.add(FormCostAmount);
		...
		public override void UpdateData() 
		{
			...
			IDIGITALTEKGRID.ApplicationBuilder.CostAmountDataSource.update(FormCostAmount);
