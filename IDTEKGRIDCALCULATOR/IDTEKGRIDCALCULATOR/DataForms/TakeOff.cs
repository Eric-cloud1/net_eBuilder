...
namespace IDIGITALTEKGRID
{
	...
	/// </summary>
	public class TakeOff : IDIGITALTEKGRID.DataForm
	{
        private IDIGITALTEKGRIDCONTROL.TakeOff takeOff1;
		...
		private void InitializeComponent()
		{
            ...
            this.takeOff1 = new IDIGITALTEKGRIDControl.TakeOff();
            this.SuspendLayout();
// 
// takeOff1
// 
...
// 
		...
		public  IDIGITALTEKGRID.TakeoffMDI  takeOff = new IDIGITALTEKGRID.TakeoffMDI();
		protected IDIGITALTEKGRID.TakeOffData FormTakeOff = new TakeOffData();
		...
		public void CreateNewTakeOff( IDIGITALTEKGRID.TakeoffMDI  _takeOff)
		{
		...
		public void CreateTakeOff( IDIGITALTEKGRID.TakeoffMDI  _takeOff)
		{
		...
		public void Edit( IDIGITALTEKGRID.TakeOffData  _formTakeOff,  IDIGITALTEKGRID.TakeoffMDI  _takeOff ) 
		{
            this.takeOff1.TakeOff_Load();
		...
		public override void InsertData() 
		{
            ...
            {
                IDIGITALTEKGRID.ApplicationBuilder.TakeOffDataSource.add(FormTakeOff, FormTakeOff.JobID.ToString());
            }
                     IDIGITALTEKGRID.ApplicationBuilder.TakeOffDataSource.add(FormTakeOff);
		...
		public override void UpdateData() 
		{
            ...
            else
            {
             ...
             IDIGITALTEKGRID.ApplicationBuilder.TakeOffDataSource.update(FormTakeOff); 
		...
		public override void DeleteData() 
		{
			...
			IDIGITALTEKGRID.ApplicationBuilder.TakeOffDataSource.delete(FormTakeOff);
		} 
