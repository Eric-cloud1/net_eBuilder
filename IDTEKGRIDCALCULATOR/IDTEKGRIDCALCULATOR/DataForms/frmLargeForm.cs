...
// 
		...
		private void btnOK_Click(object sender, System.EventArgs e)
		{
            ...
            else if ((IDIGITALTEKGRID.ApplicationBuilder.SaveExpressionMode == SaveExpression.False) && (!this.ValidateData()))
            {
				...
				switch ( result ) 
				{
					case DialogResult.Yes:
						if(this.ValidateData())
						{
							...
							else if ( IDIGITALTEKGRID.ApplicationBuilder.EditMode == DataFormEditMode.Insert) 
                            {
