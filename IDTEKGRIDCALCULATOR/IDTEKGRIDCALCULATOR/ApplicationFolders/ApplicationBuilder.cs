...
namespace IDIGITALTEKGRID
{
	...
	{
		public IDIGITALTEKGRID.DivisionDataProvider _divisionDataProvider;
        ...
        public static IDIGITALTEKGRID.AssemblyDataProvider AssemblyDataSource
		{					
			get
			{
				IDIGITALTEKGRID.AssemblyDataProvider DataSource = new AssemblyDataProvider();
				return DataSource;
			}
		}


		public static IDIGITALTEKGRID.ContactDataProvider ContactDataSource
		{					
			get
			{
				IDIGITALTEKGRID.ContactDataProvider DataSource = new ContactDataProvider();
				return DataSource;
			}
		}


		public static IDIGITALTEKGRID.CostAmountDataProvider CostAmountDataSource
		{					
			get
			{
				IDIGITALTEKGRID.CostAmountDataProvider DataSource = new CostAmountDataProvider();
				return DataSource;
			}
		}


		public static IDIGITALTEKGRID.CostItemDataProvider CostItemDataSource
		{					
			get
			{
				IDIGITALTEKGRID.CostItemDataProvider DataSource = new CostItemDataProvider();
				return DataSource;
			}
		}


		public static IDIGITALTEKGRID.JobDataProvider JobDataSource
		{					
			get
			{
				IDIGITALTEKGRID.JobDataProvider DataSource = new JobDataProvider();
				return DataSource;
			}
		}


		public static IDIGITALTEKGRID.ExpressionDataProvider ExpressionDataSource
		{					
			get
			{
				IDIGITALTEKGRID.ExpressionDataProvider DataSource = new ExpressionDataProvider();
				return DataSource;
			}
		}


		public static IDIGITALTEKGRID.QuantityDataProvider QuantityDataSource
		{					
			get
			{
				IDIGITALTEKGRID.QuantityDataProvider DataSource = new QuantityDataProvider();
				return DataSource;
			}
		}

		
		public static IDIGITALTEKGRID.EstimateDataProvider EstimateDataSource
		{					
			get
			{
                IDIGITALTEKGRID.EstimateDataProvider DataSource = new EstimateDataProvider();
                return DataSource;
			}
		}


		public static IDIGITALTEKGRID.TakeOffDataProvider TakeOffDataSource
		{					
			get
			{
				IDIGITALTEKGRID.TakeOffDataProvider DataSource = new TakeOffDataProvider();
				return DataSource;
			}
		}


		public static IDIGITALTEKGRID.ValidationSystemDataProvider ValidationSystemDataSource
		{					
			get
			{
				IDIGITALTEKGRID.ValidationSystemDataProvider DataSource = new ValidationSystemDataProvider();
				return DataSource;
			}
		}

		public static IDIGITALTEKGRID.ValidationUserDataProvider ValidationUserDataSource
		{					
			get
			{
				IDIGITALTEKGRID.ValidationUserDataProvider DataSource = new ValidationUserDataProvider();
				return DataSource;
			}
		}
