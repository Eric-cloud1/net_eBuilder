...
//* Copyright 2003, IDIGITALTEKGRID
//* All rights reserved.
//* Use of the software is subject to the 
//* terms of the IDIGITALTEKGRIDSoftware License Agreement.
//*************************************************************
...
namespace IDIGITALTEKGRID
{
	public  class stData
	{
       ...
       public string connectString ;
        ...
        public stData()
        {
          connectString = IDIGITALTEKGRID.ApplicationBuilder.connection;
        }
		...
		{	
			return IDIGITALTEKGRID.stSQL.ExecuteDataset(connectString, _SQL,true);
		}
	
		public OleDbDataReader getDataReader(string _SQL, string connectString,bool OleDB)
		{
			return IDIGITALTEKGRID.stSQL.getDataReader(connectString,_SQL,true);
		}
		public SqlDataReader getDataReader(string _SQL, string connectString)
		{
			return IDIGITALTEKGRID.stSQL.getDataReader(connectString,_SQL);
		}
		...
		public void ExecuteSQL(string _SQL, string connectString)
		{
			...
			IDIGITALTEKGRID.stSQL.ExecNonQuery(connectString,_SQL,true);
		}
		...
		public void TrySQL(string _SQL, string connectString)
		{
			...
			IDIGITALTEKGRID.stSQL.TrySQL(connectString,_SQL,true);
		}

		public int ExecuteCmdTEXT(string _cmdTEXT, string connectString)
		{
			return IDIGITALTEKGRID.MicroStell.ExecuteNonQuery(connectString,System.Data.CommandType.StoredProcedure, _cmdTEXT);		
		}

		public object ExecScalar(string _SQL, string connectString)
		{
			object Identity= IDIGITALTEKGRID.stSQL.ExecScalar(connectString, _SQL,10,true);
			return Identity;
		 }

		public object ExecIdentity( string _SQL, string connectString)
		{
			object Identity= IDIGITALTEKGRID.stSQL.ExecIdentity(_SQL,connectString,true);
			return Identity;
		}
		...
		{
			DataSet _dataSet = IDIGITALTEKGRID.stSQL.ExecuteDataset(connectString, SQL,true);
			return _dataSet;
		}
